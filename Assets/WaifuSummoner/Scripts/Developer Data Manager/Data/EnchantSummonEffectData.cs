...
namespace WaifuSummoner.Effects
{
    ...
    public class EnchantSummonEffectData
    {
        ...
        /// <summary>3) Cantidad a elegir (solo si target es Select/Random/Situational). Siempre ≥1.</summary>
        public int amount = 1;
        /// <summary>4) Extras para Situational:</summary>
        ...
        /// <summary>7) Filtros dinámicos.</summary>
        [SerializeField]
